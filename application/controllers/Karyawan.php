...
class Karyawan extends CI_Controller{
    ...
    function tambah_aksi() {
        ...
        $this->M_karyawan->input_data($data,'tabel_12210802');
    ...
    function edit ($id) {
        $where = array('id' => $id);
        $data['karyawan'] = $this->M_karyawan->edit_data($where,'tabel_12210802')->result();
        $data['status'] = ['Menikah','Belum Menikah'];
        $data['jabatan'] = ['Manager','Direktur','Staff'];
    ...
    function update() {
        ...
        $this->M_karyawan->update_data($where,$data,'tabel_12210802');
        redirect('karyawan/index');
    } 

    function hapus ($id) {
        $where = array('id' => $id);
        $this->M_karyawan->hapus_data($where,'tabel_12210802');
        redirect('karyawan/index');
    }
}